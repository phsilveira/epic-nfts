...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Silly", "Goofy", "Wacky", "Hilarious", "Zany", "Whimsical"];
  string[] secondWords = ["Banana", "Pickle", "Penguin", "Cupcake", "Noodle", "Sausage"];
  string[] thirdWords = ["Parade", "Fiesta", "Carnival", "Jamboree", "Extravaganza", "Hootenanny"];
